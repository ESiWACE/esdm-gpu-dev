...
//printf ("test_fft: timing harness for CDO operator fft\n");
//printf ("test_fft: nx %i lot %i niter %i\n",
//    nx, lot, niter);
//printf ("test_fft: cpuonly %i gpuonly %i single %i double %i\n",
